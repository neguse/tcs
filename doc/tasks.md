...
- 進捗 (2026-06-29): JetBrains InspectCode 2026.1.3 headless 実行で ProjectReference analyzer-demo と local nupkg `PackageReference` consumer の TCS1001 x4 / TCS1002 x1 が SARIF に出ることを確認し、`samples/analyzer-demo/verify-inspectcode.sh` に手順を script 化
