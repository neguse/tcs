...
- T122: Rider リアルタイム警告向け tcs Roslyn Analyzer PoC を作る
  ...
  - `samples/analyzer-demo/verify-inspectcode.sh` で JetBrains InspectCode 2026.1.3 headless 実行でも ProjectReference analyzer-demo と local nupkg `PackageReference` consumer の TCS1001 x4 / TCS1002 x1、および PackageReference consumer の TCS1002 error override を確認できる
